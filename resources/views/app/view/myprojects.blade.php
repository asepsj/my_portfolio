                    ...
                    <div class="row gy-4 isotope-container" data-aos="fade-up" data-aos-delay="200">
                        <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-app">
                            <div class="portfolio-content h-100">
                                <img src="{{ asset('storage/img/portfolio/my_portofolio1.png') }}" class="img-fluid"
                                    alt="" loading="lazy">
                        ...
                        <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-app">
                            <div class="portfolio-content h-100">
                                <img src="{{ asset('storage/img/portfolio/giku1.png') }}" class="img-fluid" alt=""
                                    loading="lazy">
                                <div class="portfolio-info">
                                    <h4>Giku App</h4>
                        ...
                        <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-app">
                            <div class="portfolio-content h-100">
                                <img src="{{ asset('storage/img/portfolio/admin_giku1.png') }}" class="img-fluid"
                                    alt="" loading="lazy">
                                <div class="portfolio-info">
                                    <h4>Admin Giku</h4>
                        ...
                        <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-app">
                            <div class="portfolio-content h-100">
                                <img src="{{ asset('storage/img/portfolio/webdesa1.png') }}" class="img-fluid" alt=""
                                    loading="lazy">
                                <div class="portfolio-info">
                                    <h4>Web Desa</h4>
